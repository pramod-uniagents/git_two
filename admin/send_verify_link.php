...
To access your account and proceed to payment, either click on the button or copy and paste the following link into the address bar of your browser:
					  ...
					  <tr>
						...
						<td style="padding:8px 10px;font-family:Arial, Helvetica, sans-serif;font-size:12px;color:#666;"><strong><a href="'.HTTP_HOST_DEMO.'/email-verified.php?rdr='.$rdr_content.'">Click here to verify your email</a></strong><br /><br />'.HTTP_HOST_DEMO.'/email-verified.php?rdr='.$rdr_content.'</td>
