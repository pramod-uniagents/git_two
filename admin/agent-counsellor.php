...
<?php include('../includes/admin-left-panel.php'); ?>
    ...
    <div class="right-panel column">
        ...
        <div class="form-container">
            ...
            <div class="form-sub-head">Search Agent Counsellor</div>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <ul class="fields border">
                        <li><span class="half half-head">Agency Name </span>
                            <div class="half no-padding"><?php echo $record[0]['agencyName']; ?>
                            </div>
                        </li>
                        <li><span class="half half-head">Address</span>
                            <div class="half no-padding"><?php echo $record[0]['address']; ?>
                            </div>
                        </li>
                        <li><span class="half half-head">City</span>
                            <div class="half no-padding"><?php echo $record[0]['city']; ?>
                            </div>
                        </li>
                        <li><span class="half half-head">State</span>
                            <div class="half no-padding"><?php echo $record[0]['state']; ?>
                            </div>
                        </li>
                        ...
                        <li><span class="half half-head">Email Address</span>
                            <div class="half no-padding"><i
                                        class="fa fa-envelope icon"></i><?php echo $record[0]['emailAddress']; ?>
                            </div>
                        </li>
                ...
                <fieldset>
                    ...
                    <ul class="fields border">
                        <li><span class="half half-head">Search Counsellor </span>
                            <div class="half no-padding"><input
                                        type="text" required="" placeholder="Search Counsellor"
                                        value="<?php echo $record[0]['contactPerson']; ?>" id="contactPerson"
                                        name="SearchPerson"></div>
                        </li>
